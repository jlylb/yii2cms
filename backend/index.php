...
require(dirname(__DIR__) . '/_protected/backend/config/bootstrap.php');
...
$config = yii\helpers\ArrayHelper::merge(
    ...
    require(dirname(__DIR__) . '/_protected/backend/config/main.php'),
    require(dirname(__DIR__) . '/_protected/backend/config/main-local.php')
);
